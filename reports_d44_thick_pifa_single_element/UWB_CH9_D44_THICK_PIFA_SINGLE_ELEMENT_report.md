...
- 已复核候选：`106` 个；S11 达标 `1` 个，增益达标 `24` 个，双指标同时达标 `0` 个。
- 当前排序候选：`#100 h8p0_l14p0_w11p2_f1355_slot`，S11 `-2.984 dB`，最佳 270° 窗口最小 GainTotal `-3.980 dBi`，结果 `未达标`。
- 当前排序候选距离 S11 目标仍差约 `7.016 dB`；说明高低仰角覆盖增益可以达标，但端口匹配仍是主瓶颈。
...
| 98 | `h8p0_w11p2_f1105_m5625` | -2.062 | -4.605 | -16.501 | 未达标 |
| 99 | `h8p0_w11p2_f1105_m6028` | -2.047 | -4.462 | -16.951 | 未达标 |
| 94 | `h8p0_w11p2_f1085_slot` | -2.003 | -3.522 | -13.386 | 未达标 |
| 93 | `h8p0_l11p4_w11p2_sw5p8_fence4p8_start2p0_feed10p45_lip1p2_edgec4p2_h6p8_match_l3p2_c0p26` | -1.879 | -4.424 | -16.033 | 未达标 |
| 92 | `h8p0_l11p4_w11p2_sw5p8_fence4p8_start2p0_feed10p35_lip1p2_edgec4p2_h6p8_slot6p2x4p4` | -1.827 | -3.321 | -12.107 | 未达标 |
| 82 | `h8p0_l12p0_w10p0_sw4p0_fence8p0_feed11p30_match_l3p0_c0p26_gap0p10_loadside` | -1.809 | -3.747 | -10.135 | 未达标 |
...
- 当前候选 AEDT 工程：`D:\WorkSpace\HFSS Sim\UWB-Antenna-Simulation-By-HFSS\UWB_CH9_D44_THICK_PIFA_SINGLE_ELEMENT_h8p0_l14p0_w11p2_f1355_slot.aedt`
