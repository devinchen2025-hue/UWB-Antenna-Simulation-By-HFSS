...
def candidates() -> list[MatchCandidate]:
    ...
    return [
        ...
        clone_candidate(
            base,
            "fold0p6_neck1p6_stub2p6",
            "Add a short radial folded open branch at the best long-stub point to increase electrical length without using more edge span.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.60,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            board_edge_fed_l_match_stub_length_mm=2.60,
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=0.60,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
        clone_candidate(
            base,
            "fold1p0_neck1p6_stub2p6",
            "Sweep a 1.0 mm folded branch around the current best point.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.60,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            ...
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=1.00,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
        clone_candidate(
            base,
            "fold1p4_neck1p6_stub2p6",
            "Sweep a 1.4 mm folded branch to bracket the extra electrical length needed for -10 dB return loss.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.60,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            ...
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=1.40,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
        clone_candidate(
            base,
            "fold1p8_neck1p6_stub2p6",
            "Sweep a 1.8 mm folded branch while preserving the best neck and straight-stub dimensions.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.60,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            ...
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=1.80,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
        clone_candidate(
            base,
            "fold2p2_neck1p6_stub2p6",
            "Push the folded branch deeper into the spare radial board space for the strongest open-stub transform in this sweep.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.60,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            ...
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=2.20,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
        clone_candidate(
            base,
            "fold1p4_neck1p4_stub2p8",
            "Trade a slightly shorter feed neck for a longer straight stub plus folded branch.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.40,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            board_edge_fed_l_match_stub_length_mm=2.80,
            board_edge_fed_l_match_stub_width_mm=0.12,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=1.40,
            board_edge_fed_l_match_fold_width_mm=0.12,
        ...
        clone_candidate(
            base,
            "fold1p8_neck1p2_stub3p0",
            "Use the previous second-best short-neck/long-stub point and add a folded branch.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.20,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
        ...
        clone_candidate(
            base,
            "fold1p2_neck1p8_stub2p4",
            "Try a longer series neck with a shorter straight stub and moderate folded branch to balance A/B state sensitivity.",
            board_edge_fed_l_feed_neck_enabled=1.0,
            board_edge_fed_l_feed_neck_length_mm=1.80,
            board_edge_fed_l_feed_neck_width_mm=0.08,
            board_edge_fed_l_match_enabled=1.0,
            ...
            board_edge_fed_l_match_stub_width_mm=0.14,
            board_edge_fed_l_match_fold_enabled=1.0,
            board_edge_fed_l_match_fold_length_mm=1.20,
            board_edge_fed_l_match_fold_width_mm=0.12,
            board_edge_fed_l_match_capacitance_pf=0.0,
            board_edge_fed_l_match_inductance_nh=0.0,
        ),
...
def write_report(payload: dict[str, Any]) -> None:
    ...
    if best["all_s11_pass"]:
        lines.append("- 匹配目标已达成；该候选保留候选 61 的真实板边馈电单极子覆盖结构，并只在 L 端口馈点旁增加小折叠匹配支路。")
        lines.append("- 完整 FOV 远场仍需作为最终同候选 signoff；本轮 AEDT 2023.1 在候选 37 全带与中心频点 FOV 求解中均停在 `Solving design setup`，未产出新的远场数据。")
    else:
