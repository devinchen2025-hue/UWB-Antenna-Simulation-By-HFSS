...
class ThickPifaCandidate:
    ...
    feed_v_mm: float = 0.0
    capacitive_feed_gap_mm: float = 0.0
    capacitive_feed_island_u_mm: float = 0.0
    capacitive_feed_island_v_mm: float = 0.0
...
def candidates() -> list[ThickPifaCandidate]:
    return [
        ...
        ThickPifaCandidate(
            name="h3p5_l9p2_w8p8_sw4p0_fence6p0_start0p4_feed8p45",
            rationale="Keep the low-height S11-pass family but widen the aperture a little and shift the side fence off the short wall to lift the horizon current.",
            substrate_h_mm=3.5,
            top_length_mm=9.2,
            top_width_mm=8.8,
            short_wall_width_mm=4.0,
            ...
            feed_from_short_mm=8.45,
        ),
        ThickPifaCandidate(
            name="h3p5_l9p2_w9p2_sw4p0_fence6p0_start0p4_feed8p45",
            rationale="Further widen the same low-height aperture to test whether the gain hole can be lifted without losing the good match.",
            substrate_h_mm=3.5,
            top_length_mm=9.2,
            top_width_mm=9.2,
            short_wall_width_mm=4.0,
        ...
        ThickPifaCandidate(
            name="h3p8_l9p2_w9p2_sw4p0_fence6p0_start0p8_feed8p50",
            rationale="Add a small height increase to the widened low-height aperture to see whether a modest vertical lift helps low-angle gain more than the match penalty.",
            substrate_h_mm=3.8,
            top_length_mm=9.2,
            top_width_mm=9.2,
            short_wall_width_mm=4.0,
        ...
        ThickPifaCandidate(
            name="h4p0_l9p2_w9p2_sw4p0_fence6p0_start0p8_feed8p50",
            rationale="Continue the same widened-aperture trend with a 4.0 mm cavity to find the next point before the return loss collapses.",
            substrate_h_mm=4.0,
            top_length_mm=9.2,
            top_width_mm=9.2,
            short_wall_width_mm=4.0,
        ...
        ThickPifaCandidate(
            name="h4p0_l9p6_w9p6_sw4p0_fence6p4_start0p8_feed8p55",
            rationale="Widen and lengthen the same low-cost cavity a little more to recover the missing low-angle gain while keeping the feed near the open side.",
            substrate_h_mm=4.0,
            top_length_mm=9.6,
            top_width_mm=9.6,
            short_wall_width_mm=4.0,
            ...
            side_fence_start_from_short_mm=0.8,
            feed_from_short_mm=8.55,
        ),
        ThickPifaCandidate(
            name="h4p0_l9p6_w9p6_sw4p0_fence6p4_start0p8_feed8p55_lip0p4",
            rationale="Add only a shallow open-edge lip to the widened 4.0 mm cavity so the gain can be checked without the slot-and-coupler detuning seen earlier.",
            substrate_h_mm=4.0,
            top_length_mm=9.6,
            top_width_mm=9.6,
            short_wall_width_mm=4.0,
            ...
            side_fence_start_from_short_mm=0.8,
            feed_from_short_mm=8.55,
            open_lip_height_mm=0.4,
            open_lip_width_mm=1.4,
        ),
        ThickPifaCandidate(
        ...
        ThickPifaCandidate(
            name="h8p0_l11p4_w11p2_sw5p8_fence4p8_start2p0_feed10p55_lip1p2_edgec4p2_h6p8_slot6p2x4p4",
            rationale="Move the feed slightly toward the open edge on the best gain-pass cavity-path geometry to see whether input resistance and S11 can be pulled down without killing low-angle gain.",
            substrate_h_mm=8.0,
            top_length_mm=11.4,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l11p4_w11p2_sw5p8_fence4p8_start2p0_feed10p75_lip1p2_edgec4p2_h6p8_slot6p2x4p4",
            rationale="Push the same 11.4 mm cavity-path geometry a bit farther toward the open edge to bracket the feed-resistance side of the match curve.",
            substrate_h_mm=8.0,
            top_length_mm=11.4,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l11p8_w11p2_sw5p8_fence4p8_start2p0_feed10p95_lip1p2_edgec4p4_h7p0_slot6p4x4p4",
            rationale="Lengthen the same cavity-path geometry slightly and pull the feed outward together with a stronger open-edge coupler to test whether the resonance can be lowered while preserving the gain ridge.",
            substrate_h_mm=8.0,
            top_length_mm=11.8,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            ...
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.4,
            open_edge_coupler_height_mm=7.0,
            top_slot_start_from_short_mm=6.4,
            top_slot_length_mm=4.6,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=6.6,
            edge_slot_length_mm=4.0,
            edge_slot_depth_mm=1.05,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l11p8_w11p2_sw5p8_fence4p8_start2p0_feed11p15_lip1p2_edgec4p4_h7p0_slot6p4x4p4",
            rationale="Continue the 11.8 mm cavity-path sweep toward the open edge to see if the impedance peak can be moved while the low-angle coverage stays intact.",
            substrate_h_mm=8.0,
            top_length_mm=11.8,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l12p4_w11p2_sw5p8_fence5p2_start2p0_feed11p75_lip1p2_edgec4p6_h7p0_slot6p8x4p8",
            rationale="Extend the meandered cavity current path to 12.4 mm while moving the feed outward and strengthening the open-edge coupler, aiming for better S11 without leaving the gain-pass ridge.",
            substrate_h_mm=8.0,
            top_length_mm=12.4,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            side_fence_length_mm=5.2,
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=11.75,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.6,
            open_edge_coupler_height_mm=7.0,
            top_slot_start_from_short_mm=6.8,
            top_slot_length_mm=4.8,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=7.0,
            edge_slot_length_mm=4.0,
            edge_slot_depth_mm=1.05,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l13p0_w11p2_sw5p8_fence5p6_start2p0_feed12p35_lip1p2_edgec4p8_h7p0_slot7p2x5p0",
            rationale="Continue the same linked current-path/feed trajectory to 13.0 mm to bracket the transition toward the best-S11 14 mm geometry.",
            substrate_h_mm=8.0,
            top_length_mm=13.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            side_fence_length_mm=5.6,
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=12.35,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.8,
            open_edge_coupler_height_mm=7.0,
            ...
            top_slot_length_mm=5.0,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=7.4,
            edge_slot_length_mm=4.2,
            edge_slot_depth_mm=1.05,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l13p6_w11p2_sw5p8_fence6p0_start2p0_feed13p05_lip1p2_edgec4p8_h7p0_slot7p6x5p0",
            rationale="Near-14 mm endpoint for the geometry-only trajectory: keep the wide aperture and longer edge-coupled current path while backing off slightly from the previous 14 mm feed extreme.",
            substrate_h_mm=8.0,
            top_length_mm=13.6,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_w11p2_f1265_edgec5p4_h7p6_lip1p8",
            rationale="Use the #100 high-gain path but pull the feed 0.9 mm back from the open edge and add stronger open-edge capacitance to reduce the measured high-R/high-jX port point.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            side_fence_length_mm=6.0,
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=12.65,
            feed_pad_radius_mm=0.55,
            port_width_mm=0.85,
            open_lip_height_mm=1.8,
            open_lip_width_mm=7.8,
            open_edge_coupler_length_mm=5.4,
            open_edge_coupler_height_mm=7.6,
            top_slot_start_from_short_mm=7.4,
            top_slot_length_mm=5.2,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=7.8,
            edge_slot_length_mm=4.6,
            edge_slot_depth_mm=1.15,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l14p0_w11p2_f1305_edgec5p4_h7p6_lip1p8",
            rationale="Bracket the feed pullback on the same capacitively strengthened open edge, looking for a lower impedance point without giving away the 270-degree low-angle gain.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_w11p2_f1335_sw6p6_edgec5p2_h7p8",
            rationale="Keep the feed near the #100 ridge but widen the short wall and deepen the side/open-edge cavity coupling to pull more current through the low-impedance wall path.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=6.6,
            side_fence_length_mm=5.6,
            side_fence_start_from_short_mm=1.4,
            feed_from_short_mm=13.35,
            feed_pad_radius_mm=0.50,
            port_width_mm=0.80,
            open_lip_height_mm=1.5,
            open_lip_width_mm=7.4,
            open_edge_coupler_length_mm=5.2,
            open_edge_coupler_height_mm=7.8,
            top_slot_start_from_short_mm=7.2,
            top_slot_length_mm=5.2,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=7.6,
            edge_slot_length_mm=4.4,
            edge_slot_depth_mm=1.15,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l13p6_w11p2_f1245_sw6p6_edgec5p4_h7p8",
            rationale="Return to the #126 footprint but move the feed farther from the open edge and strengthen both the short wall and edge coupler, directly targeting the high input resistance seen in the impedance export.",
            substrate_h_mm=8.0,
            top_length_mm=13.6,
            top_width_mm=11.2,
            short_wall_width_mm=6.6,
        ...
        ThickPifaCandidate(
            name="h8p0_l13p6_w11p2_f1275_start1p2_edgec5p6_h7p8",
            rationale="Use the #126 length with an earlier side-wall start and the strongest open-edge coupler in this batch, testing whether the cavity edge can add capacitive loading while preserving horizon current.",
            substrate_h_mm=8.0,
            top_length_mm=13.6,
            top_width_mm=11.2,
            short_wall_width_mm=6.2,
            side_fence_length_mm=5.8,
            side_fence_start_from_short_mm=1.2,
            feed_from_short_mm=12.75,
            feed_pad_radius_mm=0.55,
            port_width_mm=0.85,
            open_lip_height_mm=1.8,
            open_lip_width_mm=7.8,
            open_edge_coupler_length_mm=5.6,
            open_edge_coupler_height_mm=7.8,
            top_slot_start_from_short_mm=7.2,
            top_slot_length_mm=5.0,
            top_slot_width_mm=0.55,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_w11p2_f1365_edgec5p6_h7p8_slot8p0x5p4",
            rationale="Lengthen the #100 current path beyond 14 mm and keep the feed away from the final open-edge extreme, aiming to cancel part of the inductive reactance with a longer etched current route.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
            ...
            open_edge_coupler_length_mm=5.6,
            open_edge_coupler_height_mm=7.8,
            top_slot_start_from_short_mm=8.0,
            top_slot_length_mm=5.4,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=8.4,
            edge_slot_length_mm=4.8,
            edge_slot_depth_mm=1.15,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l14p0_capfeed_f1235_gap0p12_i0p8x2p4",
            rationale="Keep the #100 current path but replace direct probing with an etched capacitive feed island; the gap-coupled island targets the exported 130+j141 ohm inductive port without discrete parts.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            ...
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=12.35,
            capacitive_feed_gap_mm=0.12,
            capacitive_feed_island_u_mm=0.80,
            capacitive_feed_island_v_mm=2.40,
            port_width_mm=0.65,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_capfeed_f1275_gap0p10_i0p8x2p4",
            rationale="Move the capacitive island toward the #100 high-gain ridge while keeping a moderate 0.10 mm etched gap to increase coupling and reduce the direct-feed high impedance.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_capfeed_f1305_gap0p08_i0p65x2p0",
            rationale="Use a stronger narrow-gap capacitive feed close to the #100 feed ridge, bracketing whether the geometric series capacitance can recover S11 before gain collapses.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            ...
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=13.05,
            capacitive_feed_gap_mm=0.08,
            capacitive_feed_island_u_mm=0.65,
            capacitive_feed_island_v_mm=2.00,
            port_width_mm=0.60,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1345_gap0p10_i0p8x2p4",
            rationale="Combine the longer 14.8 mm current path with the capacitive island, testing whether added path length and geometric series capacitance can cancel the positive reactance together.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
            ...
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=5.2,
            open_edge_coupler_height_mm=7.2,
            top_slot_start_from_short_mm=7.8,
            top_slot_length_mm=5.0,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=8.2,
            edge_slot_length_mm=4.4,
            edge_slot_depth_mm=1.05,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l13p6_capfeed_f1245_gap0p10_i0p8x2p4",
            rationale="Apply the same capacitive island to the #126 footprint with a pulled-back feed, checking whether the shorter high-gain geometry can be matched geometrically.",
            substrate_h_mm=8.0,
            top_length_mm=13.6,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_capfeed_f1285_gap0p06_i1p2x3p0",
            rationale="Use a larger, tighter capacitive feed island as the high-coupling endpoint of the geometry-only feed study; this intentionally probes the limit before manufacturability becomes tight.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
            side_fence_length_mm=6.0,
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=12.85,
            capacitive_feed_gap_mm=0.06,
            capacitive_feed_island_u_mm=1.20,
            capacitive_feed_island_v_mm=3.00,
            port_width_mm=0.75,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=4.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1365_gap0p08_i0p8x2p4",
            rationale="Refine the #136 gain-pass capacitive feed point with slightly stronger gap coupling and a feed shifted toward the #100 open-edge ridge.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1385_gap0p06_i1p0x2p8",
            rationale="Probe the high-coupling side of the #136 ridge by moving the feed outward and using a larger island with a 0.06 mm etched gap.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
            side_fence_length_mm=6.4,
            side_fence_start_from_short_mm=2.0,
            feed_from_short_mm=13.85,
            capacitive_feed_gap_mm=0.06,
            capacitive_feed_island_u_mm=1.00,
            capacitive_feed_island_v_mm=2.80,
            port_width_mm=0.70,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
            open_edge_coupler_length_mm=5.2,
        ...
        ThickPifaCandidate(
            name="h8p0_l15p4_capfeed_f1415_gap0p08_i0p8x2p4",
            rationale="Add more etched current path length while keeping moderate capacitive feed coupling, aiming to reduce positive reactance without the gain loss seen in shorter strong-coupled cases.",
            substrate_h_mm=8.0,
            top_length_mm=15.4,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
            ...
            open_edge_coupler_length_mm=5.4,
            open_edge_coupler_height_mm=7.2,
            top_slot_start_from_short_mm=8.2,
            top_slot_length_mm=5.0,
            top_slot_width_mm=0.55,
            edge_slot_start_from_short_mm=8.6,
            edge_slot_length_mm=4.6,
            edge_slot_depth_mm=1.05,
            total_height_limit_mm=10.0,
        ),
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1365_gap0p10_i1p2x3p0",
            rationale="Increase island area on the #136 length/feed point while keeping a manufacturable 0.10 mm gap, checking whether capacitance can rise without the severe gain penalty of the tight-gap 14 mm case.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l15p4_capfeed_f1435_gap0p06_i1p0x2p8",
            rationale="High-coupling endpoint on the longer 15.4 mm current path, testing whether added electrical length can keep low-angle gain while the tighter island gap improves S11.",
            substrate_h_mm=8.0,
            top_length_mm=15.4,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1365_v1p4_gap0p10_i1p2x2p4",
            rationale="Offset the #142 capacitive feed island toward one side wall to couple into the lateral cavity current path and test whether input resistance can be reduced without losing the best-270 gain.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1365_v2p4_gap0p10_i0p9x2p0",
            rationale="Move the feed island closer to the side edge with a smaller island, directly probing side-wall coupling as an input-resistance control knob.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
            ...
            feed_v_mm=2.4,
            capacitive_feed_gap_mm=0.10,
            capacitive_feed_island_u_mm=0.90,
            capacitive_feed_island_v_mm=2.00,
            port_width_mm=0.65,
            open_lip_height_mm=1.2,
            open_lip_width_mm=7.0,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p0_f1355_v2p0_slot",
            rationale="Return to the #100 direct-fed geometry but offset the feed toward a side wall, checking whether the direct probe can reach a lower-resistance point along the lateral current path.",
            substrate_h_mm=8.0,
            top_length_mm=14.0,
            top_width_mm=11.2,
            short_wall_width_mm=5.8,
        ...
        ThickPifaCandidate(
            name="h8p0_l14p8_capfeed_f1365_v1p8_gap0p08_i0p8x2p4",
            rationale="Blend the best centered cap-feed S11 trend with a moderate side offset and tighter gap, testing a final side-coupled feed/cavity compromise.",
            substrate_h_mm=8.0,
            top_length_mm=14.8,
            top_width_mm=11.2,
            short_wall_width_mm=6.0,
...
def validate_candidate(candidate: ThickPifaCandidate) -> None:
    ...
    for label, value in [
        ...
        ("capacitive feed gap", candidate.capacitive_feed_gap_mm),
        ("capacitive feed island u", candidate.capacitive_feed_island_u_mm),
        ("capacitive feed island v", candidate.capacitive_feed_island_v_mm),
    ]:
        if value < 0.0:
            raise ValueError(f"{candidate.name}: {label} must not be negative")
    cap_feed_enabled = (
        candidate.capacitive_feed_gap_mm > 0.0
        and candidate.capacitive_feed_island_u_mm > 0.0
        and candidate.capacitive_feed_island_v_mm > 0.0
    )
    if cap_feed_enabled:
        cut_half_u = candidate.capacitive_feed_island_u_mm / 2.0 + candidate.capacitive_feed_gap_mm
        cut_half_v = candidate.capacitive_feed_island_v_mm / 2.0 + candidate.capacitive_feed_gap_mm
        if feed_u - cut_half_u <= -candidate.top_length_mm / 2.0 + 0.15:
            raise ValueError(f"{candidate.name}: capacitive feed island is too close to short wall")
        if feed_u + cut_half_u >= candidate.top_length_mm / 2.0 - 0.15:
            raise ValueError(f"{candidate.name}: capacitive feed island is too close to open edge")
        if candidate.feed_v_mm - cut_half_v <= -candidate.top_width_mm / 2.0 + 0.15:
            raise ValueError(f"{candidate.name}: capacitive feed island is too close to negative side edge")
        if candidate.feed_v_mm + cut_half_v >= candidate.top_width_mm / 2.0 - 0.15:
            raise ValueError(f"{candidate.name}: capacitive feed island is too close to positive side edge")
...
def add_thick_pifa_geometry(hfss, candidate: ThickPifaCandidate) -> list[str]:
    ...
    if cap_feed_enabled:
        gap = candidate.capacitive_feed_gap_mm
        island_half_u = candidate.capacitive_feed_island_u_mm / 2.0
        island_half_v = candidate.capacitive_feed_island_v_mm / 2.0
        cutout = builder.polygon_sheet(
            hfss,
            "E1_thick_pifa_capacitive_feed_gap",
            builder.rectangle_points(
                0.0,
                0.0,
                0.0,
                feed_u - island_half_u - gap,
                feed_u + island_half_u + gap,
                feed_v - island_half_v - gap,
                feed_v + island_half_v + gap,
                h,
            ),
            "vacuum",
        )
        slot_names.append(cutout.name)

    if slot_names:
        hfss.modeler.subtract(top.name, slot_names, keep_originals=False)

    if cap_feed_enabled:
        island = builder.polygon_sheet(
            hfss,
            "E1_thick_pifa_capacitive_feed_island",
            builder.rectangle_points(
                0.0,
                0.0,
                0.0,
                feed_u - candidate.capacitive_feed_island_u_mm / 2.0,
                feed_u + candidate.capacitive_feed_island_u_mm / 2.0,
                feed_v - candidate.capacitive_feed_island_v_mm / 2.0,
                feed_v + candidate.capacitive_feed_island_v_mm / 2.0,
                h,
            ),
            "copper",
        )
        metals.append(island.name)
