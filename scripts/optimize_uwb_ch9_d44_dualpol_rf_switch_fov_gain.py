...
GAIN_NAME_UPDATES: list[tuple[str, dict[str, Any]]] = [
    ...
    (
        "boardifa4p6_h3p8_g0p15_w0p35",
        {
            "slot_coupled_board_edge_ifa_enabled": 1.0,
            "slot_coupled_board_edge_ifa_length_mm": 4.60,
            "slot_coupled_board_edge_ifa_height_mm": 3.80,
            "slot_coupled_board_edge_ifa_gap_mm": 0.15,
            "slot_coupled_board_edge_ifa_width_mm": 0.35,
        },
    ),
    (
        "boardifa4p5_h5p5_g0p20_w0p30",
        {
            "slot_coupled_board_edge_ifa_enabled": 1.0,
            "slot_coupled_board_edge_ifa_length_mm": 4.50,
            "slot_coupled_board_edge_ifa_height_mm": 5.50,
            "slot_coupled_board_edge_ifa_gap_mm": 0.20,
            "slot_coupled_board_edge_ifa_width_mm": 0.30,
        },
    ),
    (
        "foldededge_r1p8_t4p0_h5p2_w0p30",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
            "slot_coupled_folded_edge_arm_height_mm": 5.20,
            "slot_coupled_folded_edge_arm_width_mm": 0.30,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "highfolded_r1p8_t4p0_h7p2_lim10",
        {
            "total_height_limit_mm": 10.0,
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
            "slot_coupled_folded_edge_arm_height_mm": 7.20,
            "slot_coupled_folded_edge_arm_width_mm": 0.30,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "foldededge_r1p6_t3p8_h5p0_w0p30",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.60,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 3.80,
            "slot_coupled_folded_edge_arm_height_mm": 5.00,
            "slot_coupled_folded_edge_arm_width_mm": 0.30,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "foldededge_r1p8_t4p0_h5p0_w0p24",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
    ...
    (
        "foldededge_r2p0_t4p2_h5p2_w0p25",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 2.00,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.20,
            "slot_coupled_folded_edge_arm_height_mm": 5.20,
            "slot_coupled_folded_edge_arm_width_mm": 0.25,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "foldededge_t3p6_h5p0_w0p24",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 3.60,
            "slot_coupled_folded_edge_arm_height_mm": 5.00,
            "slot_coupled_folded_edge_arm_width_mm": 0.24,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ...
    (
        "foldededge_t4p4_h5p0_w0p24",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.40,
            "slot_coupled_folded_edge_arm_height_mm": 5.00,
            "slot_coupled_folded_edge_arm_width_mm": 0.24,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ...
    (
        "foldededge_t4p0_h4p8_w0p22",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
            "slot_coupled_folded_edge_arm_height_mm": 4.80,
            "slot_coupled_folded_edge_arm_width_mm": 0.22,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "foldededge_t4p0_h5p4_w0p22",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
            "slot_coupled_folded_edge_arm_height_mm": 5.40,
            "slot_coupled_folded_edge_arm_width_mm": 0.22,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
    (
        "foldedmatch_stub1p70_step0p80",
        {
            "slot_coupled_stub_length_mm": 1.70,
            "slot_coupled_step_length_mm": 0.80,
        },
    ),
    (
        "foldedmatch_aper5p4_stub1p80",
        {
            "slot_coupled_aperture_length_a_mm": 5.40,
            "slot_coupled_aperture_length_b_mm": 5.40,
            "slot_coupled_stub_length_mm": 1.80,
        },
    ),
    (
        "foldededge_t3p8_h4p8_w0p22",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 3.80,
    ...
    (
        "foldededge_t4p0_h4p7_w0p20",
        {
            "slot_coupled_folded_edge_arm_enabled": 1.0,
            "slot_coupled_folded_edge_arm_radial_length_mm": 1.80,
            "slot_coupled_folded_edge_arm_tangent_length_mm": 4.00,
            "slot_coupled_folded_edge_arm_height_mm": 4.70,
            "slot_coupled_folded_edge_arm_width_mm": 0.20,
            "slot_coupled_folded_edge_arm_turn_sign": 1.0,
        },
    ),
...
def candidate_pool() -> list[GainCandidate]:
    ...
    custom = [
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_boardifa4p6_h3p8_g0p15_w0p35",
            "Add a parasitic board-edge IFA dedicated to low-elevation coverage while preserving the current RF-switch feed model.",
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_boardifa4p5_h5p5_g0p20_w0p30",
            "Use a taller parasitic board-edge IFA inside the original 8 mm height envelope to strengthen horizon radiation.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=1.0,
            slot_coupled_board_edge_ifa_length_mm=4.50,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_r1p8_t4p0_h5p2_w0p30",
            "Spend the available 8 mm profile on a raised folded edge arm connected to the radiator for horizontal-plane coverage.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_highfolded_r1p8_t4p0_h7p2_lim10",
            "Relax the external profile to 10 mm and raise the folded arm to test whether height is the missing horizon-coverage lever.",
            total_height_limit_mm=10.0,
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_r1p6_t3p8_h5p0_w0p30",
            "Slightly shorten and lower the folded edge arm from candidate 41 to recover S11 while keeping the horizon current path.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_r1p8_t4p0_h5p0_w0p24",
            "Keep the candidate 41 footprint but narrow/lower the folded edge arm to reduce match loading.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_r2p0_t4p2_h5p2_w0p25",
            "Use a thinner, slightly longer folded arm to test whether added electrical length can preserve gain with a better match.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t3p6_h5p0_w0p24",
            "Shorten only the folded edge tangent arm around candidate 44 to check whether the horizon gain peak is over-length tuned.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t4p4_h5p0_w0p24",
            "Lengthen only the folded edge tangent arm around candidate 44 to bracket the electrical-length optimum.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t4p0_h4p8_w0p22",
            "Lower and narrow the folded edge arm slightly to improve matching while keeping the candidate 44 footprint.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t4p0_h5p4_w0p22",
            "Raise the narrowed folded edge arm to see whether a little extra height lifts coverage without hurting S11.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldedmatch_stub1p70_step0p80",
            "Keep candidate 44 geometry and soften the stub/step loading to recover any match-limited realized-gain loss.",
            slot_coupled_stub_length_mm=1.70,
            slot_coupled_step_length_mm=0.80,
        ),
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldedmatch_aper5p4_stub1p80",
            "Keep candidate 44 geometry and slightly shorten the apertures/stub as a coupled matching compensation.",
            slot_coupled_aperture_length_a_mm=5.40,
            slot_coupled_aperture_length_b_mm=5.40,
            slot_coupled_stub_length_mm=1.80,
        ),
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t3p8_h4p8_w0p22",
            "Move halfway between candidate 46 and 48: shorter tangent than 48, same lower/narrow arm, aiming to cross the -10 dB S11 line.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t3p8_h4p8_w0p20",
            "Use the same tangent/height as the midpoint candidate but narrow the arm to reduce match loading.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
        ...
        clone_candidate(
            gain_base,
            f"{gain_base.name}_foldededge_t4p0_h4p7_w0p20",
            "Keep candidate 48 length but lower and narrow the arm a bit more to recover S11 with minimal gain loss.",
            slot_coupled_edge_arm_enabled=0.0,
            slot_coupled_edge_wall_enabled=0.0,
            slot_coupled_board_edge_ifa_enabled=0.0,
            slot_coupled_folded_edge_arm_enabled=1.0,
...
def rank_summary(rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    return sorted(
        rows,
        key=lambda row: (
            0 if bool_field(row.get("all_workstate_s11_pass")) else 1,
